...
sr.reveal('.category__card', {interval: 500 })
...
const bmws = document.querySelectorAll('.bmw')
const audis = document.querySelectorAll('.audi')
const benzs = document.querySelectorAll('.benz')
